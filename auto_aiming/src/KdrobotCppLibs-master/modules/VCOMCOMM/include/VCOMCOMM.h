...
public slots:
    void TrackleData(uint8_t fun_code, uint16_t id, const QByteArray &data);
...
signals:
    ...
    // void CrossThreadTransmitSignal(uint8_t fun_code, uint16_t id, const Vcomcomm_Data &data);
};
#endif